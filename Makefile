#############################################################################
# Makefile for building: Orkit-Qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? 18. ??? 06:05:57 2018
# Project:  Orkit-Qt.pro
# Template: app
# Command: c:/qt/4.8.6/bin/qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile Orkit-Qt.pro
#############################################################################
...
Makefile: Orkit-Qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/ORKIT/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/ORKIT/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/ORKIT/src/leveldb/libleveldb.a: FORCE
