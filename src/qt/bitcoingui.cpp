    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("Orkit") + " - " + tr("Wallet"));
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Orkit address"));
    ...
    aboutAction = new QAction(tr("&About Orkit"), this);
    aboutAction->setToolTip(tr("Show information about Orkit"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Orkit"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Orkit client") + QString(" ") + tr("[testnet]"));
...
//    trayIconMenu->>setStyleSheet("QWidget { background-repeat: no-repeat; background-image: url(:/images/bkg); border-color: red; }");
    ...
    trayIcon->setToolTip(tr("Orkit client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Orkit network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Orkit address or malformed URI parameters."));
    }
